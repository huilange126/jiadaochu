			...
			<div class="am-panel-bd">
				<form class="am-form am-form-horizontal" method="POST" action="<?php echo U(GROUP_NAME.'/Deyu/addHandle');?>" enctype=”multipart/form-data”>
					...
					<div class="am-form-group">
						...
						<div class="am-u-sm-2 am-u-end">
							<input type="text" name="shijian" class="am-form-field" placeholder="选择奖惩日期" data-am-datepicker readonly required value="<?php echo date('Y-m-d',time());?>" />
						</div>
					</div>
					<div class="am-form-group">
						...
						<div class="am-u-sm-4 am-u-end">
							<div class="am-form-group">
								<label class="am-radio-inline">
									<input type="radio" checked="checked"  value="1" name="leixing"> 奖励信息
								</label>
								<label class="am-radio-inline">
					...
					<div class="am-form-group">
						<div class="am-u-sm-6 am-u-end">
							<button class="am-btn am-btn-primary am-center">奖惩信息添加</button>
						</div>
					</div>
				</form>
			</div>
