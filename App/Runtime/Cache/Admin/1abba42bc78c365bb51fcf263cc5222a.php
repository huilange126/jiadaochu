...
<div class="am-g am-padding">
	<div class="am-panel am-panel-secondary">
		<div class="am-panel-hd">管理员修改</div>
			...
			<form class="am-form am-form-horizontal" method="POST" action="<?php echo U(GROUP_NAME.'/Admin/addHandle');?>">
				<div class="am-form-group">
					...
					<div class="am-u-sm-4 am-u-end">
						<input type="text" name="username" value="<?php echo ($admin['username']); ?>" id="doc-ipt-3" placeholder="管理员账号">
				...
				<div class="am-form-group">
					<div class="am-u-sm-6 am-u-end">
						<button class="am-btn am-btn-primary am-center">修改管理员</button>
					</div>
				</div>
			</form>
		</div>
