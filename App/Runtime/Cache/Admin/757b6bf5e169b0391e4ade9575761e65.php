			...
			<div class="am-panel-bd am-cf">
				<form class="am-form am-form-horizontal" method="POST" action="<?php echo U(GROUP_NAME.'/EnrollmentContent/addHandle');?>">
					...
					<div class="am-form-group">
						...
						<div class="am-u-sm-4 am-u-end">
							<input type="text" name="mingcheng" class="" id="doc-ipt-email-1" placeholder="输入报名项目名称" value="<?php echo ($content['mingcheng']); ?>">
					...
					<div class="am-form-group">
						...
						<?php if(is_array($enrollment['nianji'])): foreach($enrollment['nianji'] as $key=>$v): ?><label class="am-checkbox-inline">
								<input type="checkbox"<?php if(in_array($v['id'],$content['nianji'])): ?>checked="checked"<?php endif; ?>name="chkNianji[]" value="<?php echo ($v['id']); ?>"> <?php echo ($v['mingcheng']); ?>
					...
					<div class="am-form-group">
						...
						<div class="am-u-sm-4 am-u-end">
							...
							<input type="radio" checked="checked" <?php if($content['nannv'] == 2): ?>checked="checked"<?php endif; ?>  name="nannv" value="2"> 男女均报
							</label>
							<label class="am-radio-inline">
								<input type="radio" name="nannv" <?php if($content['nannv'] == 1): ?>checked="checked"<?php endif; ?>  value="1"> 男生项目
							</label>
							<label class="am-radio-inline">
								<input type="radio" name="nannv" <?php if($content['nannv'] == 0): ?>checked="checked"<?php endif; ?>  value="0"> 女生项目
							</label>
							<label class="am-radio-inline">
								<input type="radio" name="nannv"  <?php if($content['nannv'] == 3): ?>checked="checked"<?php endif; ?>  value="3"> 无性别要求
							</label>
						</div>
					</div>
					<div class="am-form-group">
						...
						<div class="am-u-sm-1 am-u-end">
							<input type="text" name="renshu" value="<?php echo ($content['renshu']); ?>" placeholder="输入限报人数">
						</div>
					</div>
					<div class="am-form-group">
						<label for="doc-ipt-email-1" class="am-u-sm-2 am-text-right">男生可报数量</label>
						<div class="am-u-sm-1">
							<input type="text" name="nansheng" value="<?php echo ($content['nansheng']); ?>">
						</div>
						<label for="doc-ipt-email-1" class="am-u-sm-2 am-text-right">女生可报数量</label>
						<div class="am-u-sm-1 am-u-end">
							<input type="text" name="nvsheng" value="<?php echo ($content['nvsheng']); ?>">
						</div>
					</div>
					<div class="am-form-group">
						...
						<div class="am-u-sm-4 am-u-end">
							<label class="am-radio-inline">
								<input type="radio" value="1" <?php if($content['leixing'] == 1): ?>checked="checked"<?php endif; ?>  name="leixing"> 田赛
							</label>
							<label class="am-radio-inline">
								<input type="radio"  <?php if($content['leixing'] == 2): ?>checked="checked"<?php endif; ?>  value="2" name="leixing"> 径赛
							</label>
							<label class="am-radio-inline">
								<input type="radio"  <?php if($content['leixing'] == 3): ?>checked="checked"<?php endif; ?>  value="3" name="leixing"> 一般报名类型
							</label>
						</div>
					</div>
					<div class="am-form-group">
						...
						<div class="am-u-sm-4 am-u-end">
							<label class="am-radio-inline">
								<input type="radio" value="0" name="jiti" <?php if($content['jiti'] == 0): ?>checked="checked"<?php endif; ?>> 个人项目
							</label>
							<label class="am-radio-inline">
								<input type="radio" value="1" name="jiti" <?php if($content['jiti'] == 1): ?>checked="checked"<?php endif; ?>> 集体项目
							</label>
						</div>
					</div>
					<div class="am-form-group">
						...
						<div class="am-u-sm-2 am-u-end">
							<label class="am-radio-inline">
								<input type="radio"  <?php if($content['status'] == 1): ?>checked="checked"<?php endif; ?>  value="1" name="status"> 启用
							</label>
							<label class="am-radio-inline">
								<input type="radio"  <?php if($content['status'] == 0): ?>checked="checked"<?php endif; ?>  value="0" name="status"> 禁用
							</label>
						</div>
					</div>
					<div class="am-form-group">
						<div class="am-u-sm-6 am-u-end">
							<button class="am-btn am-btn-primary am-center" id="btnadd">更新报名项目</button>
						</div>
					</div>
				</form>
			</div>
