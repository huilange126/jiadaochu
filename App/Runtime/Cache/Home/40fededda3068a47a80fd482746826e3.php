...
<div class="am-g am-g-fixed am-margin-top">
	...
	<div class="am-panel am-panel-success">
		...
		<div class="am-panel-bd">
			<form class="am-form am-form-horizontal" action="<?php echo U(GROUP_NAME.'/StudentFenshu/modifyHandle');?>" method="POST">
				...
				<div class="am-form-group">
					<label for="doc-ipt-3" class="am-u-md-2 am-form-label">姓名</label>
					<div class="am-u-md-3 am-u-end">
				...
				<div class="am-form-group">
					...
					<div class="am-u-md-3 am-u-end">
						<input type="hidden" name="chengji" value="<?php echo ($chengji['id']); ?>">
