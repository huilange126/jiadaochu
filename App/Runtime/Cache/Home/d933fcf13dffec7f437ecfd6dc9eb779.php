			...
			<form class="am-form am-form-horizontal" action="<?php echo U(GROUP_NAME.'/Chengji/addHandle');?>" method="POST">
				<div class="am-form-group">
					...
					<div class="am-u-md-3 am-u-end">
						<select id="doc-select-1" name="xueke">
							...
							<?php if(is_array($xueke)): foreach($xueke as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"<?php if($v['id'] == $kaoshi['xueke']): ?>selected="selected"<?php endif; ?>><?php echo ($v['xueke']); ?></option><?php endforeach; endif; ?>
						</select>
				...
				<div class="am-form-group">
					...
					<div class="am-u-md-6 am-u-end">
						<input type="text" name="mingcheng" value="<?php echo ($kaoshi['mingcheng']); ?>" placeholder="请添加考试名称">
					</div>
				</div>
				<div class="am-form-group">
					<label for="doc-ipt-3" class="am-u-md-2 am-form-label">考试时间</label>
					<div class="am-u-md-2 am-u-end">
						<input type="text" name="shijian" value="<?php echo (date('Y-m-d',$kaoshi['shijian'])); ?>" class="am-form-field" placeholder="考试时间" data-am-datepicker readonly required />
					</div>
				</div>
				<div class="am-form-group">
					<label for="doc-ipt-3" class="am-u-md-2 am-form-label">满分</label>
					<div class="am-u-md-2 am-u-end">
						<input type="text" name="manfen" value="<?php echo ($kaoshi['manfen']); ?>" class="am-form-field" placeholder="满分值" />
					</div>
				</div>
				<div class="am-form-group">
					<div class="am-u-md-6 am-u-end">
						<button class="am-btn am-btn-primary am-center" id="btnadd">修改考试</button>
					</div>
				</div>
			</div>
	</div>
