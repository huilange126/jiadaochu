...
<div class="am-g am-g-fixed am-margin-top">
	...
	<div class="am-panel am-panel-warning">
		<div class="am-panel-hd am-cf">消息管理 <a href="<?php echo U(GROUP_NAME.'/Jiaodaochu/index');?>" class="am-btn am-btn-success am-margin-left am-btn-xs">返回班级首页</a></div>
		<table class="am-table am-table-bordered am-table-striped am-table-hover">
			<thead>
			<tr class="am-active">
					<th colspan="5">消息列表
					[<a href="<?php echo U(GROUP_NAME.'/Notice/add');?>">添加消息</a>]
			...
			<tbody>
				<tr class="am-success">
					...
					<td class="am-text-center" style="width:10%">消息时间</td>
					<td>消息名称</td>
				...
				<?php if(is_array($kaoshi)): foreach($kaoshi as $key=>$v): ?><tr>
						...
						<ul class="am-nav">
							<li class="am-dropdown" data-am-dropdown>
								...
								<ul class="am-dropdown-content">
									...
									<li><a href="<?php echo U(GROUP_NAME.'/Chengji/modifyKaoshi',array('id'=>$v['id']));?>">编辑消息</a></li>
									<li><a href="<?php echo U(GROUP_NAME.'/Chengji/del',array('id'=>$v['id']));?>">删除消息</a></li>
								</ul>
							</li>
						</ul>
					...
					<a href="<?php echo U(GROUP_NAME.'/Chengji/modifyKaoshi',array('id'=>$v['id']));?>" class="am-btn am-btn-primary am-btn-xs">编辑消息</a>
					<a href="<?php echo U(GROUP_NAME.'/Chengji/del',array('id'=>$v['id']));?>" class="am-btn am-btn-danger am-btn-xs" name="del">删除消息</a> -->
					</td>
